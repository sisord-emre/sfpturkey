...
?>
<?php if (!$siparisOdemeTipiId == 2) { //havale eft değilse ?> 
<div id="nt_content">
							...
							<form action="" id="formpost" method="POST" class="card-form">
								<fieldset class="mb-1">
									...
									<div class="form-group">
										<input type="text" class="form-control card-number" name="number" id="card-number" maxlength="19" value="4444 5555 6666 7777" placeholder="<?=$fonk->getDil('kart-numarasi') ?>" autocomplete="off" onkeyup="cardAktarim();" required>
									</div>
								</fieldset>
								<fieldset class="mb-1">
									<h5><?=$fonk->getDil('kart-uzerindeki-isim') ?></h5>
									<div class="form-group">
										<input type="text" class="form-control card-name" name="name" id="card-name" placeholder="<?=$fonk->getDil('kart-uzerindeki-isim') ?>" value="PAYTR TEST" autocomplete="off" onkeyup="cardAktarim();" required>
									</div>
								</fieldset>
								<div class="row">
									<div class="col-md-6">
										<fieldset class="mb-1">
											...
											<div class="form-group">
												<input type="text" class="form-control card-expiry" name="expiry" id="card-expiry" onkeyup="formatKontrol()" placeholder="03/24" value="12/24" autocomplete="off" required>
											</div>
										</fieldset>
									</div>
									<div class="col-md-6">
										<fieldset class="mb-1">
											<h5>CVC</h5>
											<div class="form-group">
												<input type="text" class="form-control card-cvc" name="cvc" id="card-cvc" maxlength="16" placeholder="CVC" value="000" autocomplete="off" onkeyup="cardAktarim();" required>
											</div>
										</fieldset>
									</div>
								</div>
									...
									<div class="col-md-12">
										<fieldset class="mb-1">
											<div class="form-group" style="text-align:center">
												...
												<input type="hidden" name="tutar" value="<?=$fonk->paraCevir($toplamTutar,$urun["paraBirimKodu"],"TRY");?>" />
												...
												<button type="submit" id="odemeYap" class="btn btn-outline-primary-2 btn-order btn-block" style="width: auto;"><?=$fonk->getDil('odemeyi-tamamla') ?></button>
...
<script>
	<?php if (!$siparisOdemeTipiId == 2) { //iysico ?>
