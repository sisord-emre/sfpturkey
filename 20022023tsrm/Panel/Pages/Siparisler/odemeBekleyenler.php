					...
					<div class="card">
						<div class="card-header">
							...
							<div class="heading-elements">
								...
								<?php } if($eklemeYetki){?>
								<?php } if($eklemeYetki){?>
									<button type="button" onclick="TumunuTemizle();" id="tumunuSilButton" class="btn mr-1 btn-danger btn-sm"><i class="la la-trash-o"></i> <?=$fonk->getPDil("Tümünü Temizle")?></button>
								<?php } ?>
							</div>
						</div>
										...
										<tbody>
											...
											foreach($listeleme as $list){
												...
												foreach($siparisIcerikleri as $siparisIcerik){
													$icerikSayac++;
													if ($icerikSayac<=2) {
														$icerik.="<span style='display: flex;width: max-content;'>".$siparisIcerik["siparisIcerikUrunVaryantDilBilgiAdi"]."</span>";
													}else{
