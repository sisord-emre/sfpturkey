																...
																<div class="row">
																	<div class="col-md-6">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control border-primary" id="varyantDilBilgiBaslik-<?=$dil["dilId"]?>" name="varyantDilBilgiBaslik-<?=$dil["dilId"]?>" value="<?=$item['varyantDilBilgiBaslik']?>" autocomplete="off">
																		</div>
																	</div>
																</div>
															</div>
