                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<a href="'.$sabitB["sabitBilgiSiteUrl"].'"><img src="'.$sabitB["sabitBilgiSiteUrl"].'img/logo.jpg" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext /></a>
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">                                                              
                                                                <p>Web sitemize şifrenizi sıfırlama isteği kayıtlı yeni şifrenizi oluşturabilirsiniz.</p>
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                          ...
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              ...
                                                              <tr mc:repeatable>                                                               
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                  	<a href="'.$sabitB["sabitBilgiSiteUrl"].'new-password.php?tkn='.$tkn.'">
                                                                   		'.$sabitB["sabitBilgiSiteUrl"].'new-password.php?tkn='.$tkn.'
                                                                  	</a>
                                                                  </td>
                                                              </tr>
                                                          </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2023 '.$sabitB["sabitBilgiSiteAdi"].', All rights reserved.</em>
