...
<html>
    <head>
		...
		<style type="text/css">
			...
			*/
			.dataTableHeading{
				/*@editable*/ background-color:#C3DDBB;
				/*@editable*/ color:#318841;
			...
			*/
			.templateButton{
				...
				/*@editable*/ background-color:#318841;
				/*@editable*/ border:0;
                                            ...
                                            <td valign="top">
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">                                                              
																<h2>' . $siparis["uyeAdi"]  .' '.$siparis["uyeSoyadi"]. ', ' . $fonk->getPDil("siparişiniz için teşekkürler!") . '</h2>
																<p><strong>' . $fonk->getPDil("Her şey yolunda gitti ve ürünleriniz gönderilir gönderilmez sizinle iletişime geçeceğiz.") . '</strong></p>
                                                            </div>
														</td>
                                                    </tr>
													...
													<tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                         ' . $fonk->getPDil("Sipariş detayları") . '
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                         ' . $fonk->getPDil("Müşteri Adı: ") . ' <b>' . $siparis["uyeAdi"] .' '.$siparis["uyeSoyadi"] .  '
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
														' . $fonk->getPDil("Sipariş Numarası: ") . ' <b>' . $siparis["siparisKodu"] . '
                                                        </td>
                                                    </tr>
													
                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
														' . $fonk->getPDil("Sipariş tarihi: ") . '  <b>' . $fonk->sqlToDateTime($siparis["siparisKayitTarihi"]) . '
                                                        </td>
                                                    </tr>

                                                    <tr>
														<td valign="top" style="padding-top:0; padding-bottom:0;">
														' . $fonk->getPDil("Sipariş Notu: ") . '  <b>' . $siparis["siparisNot"] . '
														</td>
													</tr>
                                                    ...
                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
																<tr>
																	<th scope="col" valign="top" width="30%" class="dataTableHeading" mc:edit="data_table_heading00">
																		' . $fonk->getPDil("Ürün Görsel") . '
																	</th>
																	<th scope="col" valign="top" width="30%" class="dataTableHeading" mc:edit="data_table_heading00">
																		' . $fonk->getPDil("Ürün Adı") . '
																	</th>
																	<th scope="col" valign="top" width="35%" class="dataTableHeading" mc:edit="data_table_heading01">
																		' . $fonk->getPDil("Adet") . '
																	</th>
																	<th scope="col" valign="top" width="35%" class="dataTableHeading" mc:edit="data_table_heading02">
																		' . $fonk->getPDil("Fiyat") . '
																	</th>
																</tr>';
															  	$toplamTutar = 0;
																...
																$siparisOdenenIskontoUcreti=$siparis["siparisOdenenIskontoUcreti"]; //iskonto ücreti atamasını yaptık
															  	foreach ($siparisIcerikleri as $val) {
																	...
																	if ($val['siparisIndirimKodu'] != "" && $val['siparisIndirimYuzdesi'] != 0) {
																		...
																		$indirimMiktar = $siparis["paraBirimSembol"] . round($indirimMiktar, 2);
																	}
																	if ($val['siparisKargoUcreti'] != 0) {
																		$toplamTutar += $val['siparisKargoUcreti'];
																		$siparisKargoUcreti = $siparis["paraBirimSembol"] . round($val['siparisKargoUcreti'], 2);
																	}
															  	$body = $body . 
																'
																<tr mc:repeatable>
																	<td valign="top" class="dataTableContent" mc:edit="data_table_content00">
																		<a href="' . $val['urunBaseUrl'] . $val['urunGorsel'] . '">
																			<img src="' . $val['urunBaseUrl'] . $val['urunGorsel'] . '"
																	...
																	<td valign="top" class="dataTableContent" mc:edit="data_table_content02">
																		<p>' . round(($val['siparisIcerikFiyat']), 2) . '  ₺</p>
																	</td>
                                                              	</tr>';
																}
																$body = $body . '
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
													<tbody>
														<tr>
															<td>
																<div class="col-6" style="text-align: right; padding:20px;">
																' . $fonk->getPDil("Ara toplam") . ':	₺' . round(($araTutar), 2) . '<br>
																' . $fonk->getPDil("İndirim") . ':	₺' . round(($indirimMiktar), 2) . '<br>
																' . $fonk->getPDil("İskonto") . ':	₺' . round(($siparisOdenenIskontoUcreti), 2) . '<br>
																' . $fonk->getPDil("Gönderim Ücreti") . ':	₺' . round(($siparisKargoUcreti), 2) . '<br>
																	<br>
																	<strong>' . $fonk->getPDil("Toplam") . ': 	₺' . round(($toplamTutar-$siparisOdenenIskontoUcreti), 2) . '</strong><br>
																	<br>
											  ...
											  <table border="0" cellpadding="20" cellspacing="0" width="100%">
												...
												<td valign="top" class="bodyContent">
													<div mc:edit="std_content01">
														<table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
													  <tr>
														  <th scope="col" valign="top" width="100%" class="dataTableHeading" mc:edit="data_table_heading00">
															 ' . $fonk->getPDil("Teslimat adresi") . '
														  </th>                                                               
													  </tr>
													  <tr mc:repeatable>
														  <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
															
															' . $siparis["uyeAdi"] .' '.$siparis["uyeSoyadi"] . '<br />
															' . $siparis["uyeAdresBilgi"] . '<br />
															' . $siparis["uyeMail"] . '<br />
															' . $siparis["uyeTel"] . '<br />
															<strong>
															' . $fonk->getPDil("Lütfen teslimat adresi detaylarınızı dikkatlice kontrol ediniz. Yukarıda gösterilen bir şey doğru değilse,
																lütfen mümkün olan en kısa sürede bize bildirin; müşteri hizmetleri ekibimiz size yardımcı olmaktan mutluluk duyacaktır.") . '
															</strong><br />
