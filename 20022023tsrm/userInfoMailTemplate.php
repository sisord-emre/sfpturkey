                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	<a href="'.$sabitB["sabitBilgiSiteUrl"].'"><img src="'.$sabitB["sabitBilgiSiteUrl"].'assets/images/logo.jpeg" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext /></a>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // End Template Header \\ -->
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <p>'.$fonk->getDil('Kayıtınız başarıyla oluşturuldu.').'</p>
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
															...
															<tr>
																<th scope="col" valign="top" width="30%" class="dataTableHeading" mc:edit="data_table_heading00">
																	'.$fonk->getDil('Vergi Levhası').'
																</th>
															</tr>
															<tr mc:repeatable>
																<td valign="top" class="dataTableContent" mc:edit="data_table_content00">';
																foreach($uyeVergiLevhasi as $val){
																	$body=$body.'
																	<a href="'.$val['uyeVergiLevhasiBaseUrl'].''.$val['uyeVergiLevhasiDosya'].'">
                                                                   		Görüntüle
                                                                  	</a><br>';
																	}
																	$body=$body.'
															...
															<tr>
																<th scope="col" valign="top" width="30%" class="dataTableHeading" mc:edit="data_table_heading00">
																	'.$fonk->getDil('Ticaret sicil gazetesi').'
																</th>
															</tr>
															<tr mc:repeatable>
																<td valign="top" class="dataTableContent" mc:edit="data_table_content00">
																	<a href="'.$uye['uyeTicaretSicilGazetesiBaseUrl'].''.$uye['uyeTicaretSicilGazetesi'].'">
                                                                   		Görüntüle
                                                                  	</a>
																</td>
															</tr>
															...
															<tr>
																<th scope="col" valign="top" width="30%" class="dataTableHeading" mc:edit="data_table_heading00">
																	'.$fonk->getDil('Mükerrer İmza').'
																</th>
															</tr>
															<tr mc:repeatable>
																<td valign="top" class="dataTableContent" mc:edit="data_table_content00">
																	<a href="'.$uye['uyeMukerrerImzaBaseUrl'].''.$uye['uyeMukerrerImza'].'">
																		Görüntüle
																	</a>
																</td>
															</tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2022 '.$sabitB["sabitBilgiSiteAdi"].', All rights reserved.</em>
