                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
													...
													<tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable" style="font-size:14px;">
																<tr>
																	<th scope="col" valign="top" colspan="2" width="100%" class="dataTableHeading" mc:edit="data_table_heading00">
													...
													<tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable" style="font-size: 14px;">
																<tr>
																	<th scope="col" valign="top" colspan="2" width="100%" class="dataTableHeading" mc:edit="data_table_heading00">
																		' . $fonk->getPDil("Talimatlar") . '
																	</th>
																</tr>
																<tr>
																	<td valign="top" style="padding-top:0; padding-bottom:5px;">
																		' . $fonk->getPDil("Banka Havalesi/EFT Talimatları: ") . '
																	</td>
																</tr>
																<tr>
																	<td valign="top" style="padding-top:0; padding-bottom:0;">
