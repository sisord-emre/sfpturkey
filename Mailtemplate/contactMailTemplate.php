                              ...
                              <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                ...
                                <tr mc:repeatable>
                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                    '.$fonk->getPDil("İsim").' : '.$iletisimFormAdSoyad.' <br />
                                    '.$fonk->getPDil("Email").' : '.$iletisimFormEmail.' <br />
                                    '.$fonk->getPDil("Telefon").' : '.$iletisimFormTel.' <br />
                                    '.$iletisimFormMesaj.'
                                  </td>
                                </tr>
                              </table>
                        ...
                        <tr>
                          <td valign="top">
                            <div mc:edit="std_footer">
                              <em>Copyright &copy; 2023 '.$sabitB["sabitBilgiSiteAdi"].', Her hakkı saklıdır.</em>
