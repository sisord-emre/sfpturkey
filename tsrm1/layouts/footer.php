                            ...
                            <div class="widget_footer">
                                <div class="footer-contact">
                                    ...
                                    <p>
                                        ...
                                        <span>Barbaros Mahallesi Bekir Sıtkı Sezgin Sokak No.8/2 <br>
                                            <span class="pl__30">Koşuyolu Üsküdar İstanbul</span>
                                        </span>
                                    </p>
                                    <p><i class="pegk pe-7s-mail"></i>
                                        <span>
                                            <a href="mailto:info@sfpturkiye.com">
                                                info@sfpturkiye.com
                                            </a>
                                        </span>
                                    </p>
                        ...
                        <div class="widget widget_nav_menu">
                            ...
                            <div class="menu_footer widget_footer">
                                <ul class="menu">
                                    <li class="menu-item">
                                        <a href="">
                                            Garanti Kapsamı, Sipariş İptali, Değişim ve İade Prosedürü
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="">
                                    ...
                                    <li class="menu-item">
                                        <a href="">
                                            Sipariş Takibi ve Kargo Prosedürü
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="">
                                    ...
                                    <li class="menu-item">
                                        <a href="">
                                            TP-Link Media Convertor + SFP
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="">
                                            Türkiye SFP Transceiver Kampanyası
                                        </a>
                                    </li>
                                </ul>
                            </div>
