...
if(!$eklemeYetki && !$duzenlemeYetki)
{
	...
	$kontrol= $fonk->imageResizeUpload($_FILES['sabitBilgiProductGorsel'],'../../Images/Ayarlar/','product',1920,125,jpg);//boyutlandırmalı resim yükleme yükleme başarılı ise 1 döner
	...
	if($_POST['formdan']=="1"){
		...
		$parametreler=array(
			...
			'sabitBilgiYoutube' => $sabitBilgiYoutube,
			'sabitBilgiBildirimMail' => $sabitBilgiBildirimMail,
			'sabitBilgiMinSepetUcret'=> $sabitBilgiMinSepetUcret,
			'sabitBilgiKargoUcret'=> $sabitBilgiKargoUcret,
			'sabitBilgiUstYazi' => "",
			'sabitBilgiProductGorselBaseUrl' => $sabitB["sabitBilgiSiteUrl"]."Panel/Images/Ayarlar/"
		);

		if($kontrol==1){//eğer duruma göre boş bırakılabiliyor ise parametre, sonradan arraye eklenir
			$parametreler=array_merge($parametreler,array('sabitBilgiProductGorsel' => "product.jpg"));
		}
							...
							<form id="formpost" class="form" action="" method="post">
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-2">
											<div class="form-group">
												<label for="sabitBilgiProductGorsel"><?=$fonk->getPDil("Product Görsel (jpg)")?></label>
												<div class="custom-file">
													<input type="file" class="custom-file-input" name="sabitBilgiProductGorsel" id="sabitBilgiProductGorsel">
													<label class="custom-file-label" name="sabitBilgiProductGorsel" id="sabitBilgiProductGorsel" for="sabitBilgiProductGorsel" aria-describedby="sabitBilgiProductGorsel"><?=$fonk->getPDil("Dosya Seçiniz")?></label>
												</div>
											</div>
										</div>
										<div class="col-md-2">
										...
										<div class="col-md-2">
											<div class="form-group">
												<label for="sabitBilgiYoutube"><?=$fonk->getPDil("Youtube")?></label>
												<input type="text" id="sabitBilgiYoutube" class="form-control border-primary" name="sabitBilgiYoutube" value="<?=$Listeleme['sabitBilgiYoutube']?>" autocomplete="off">
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label for="sabitBilgiMinSepetUcret"><?=$fonk->getPDil("Minimum Sepet Ücreti / Kargo")?></label>
												<input type="text" id="sabitBilgiMinSepetUcret" class="form-control border-primary" name="sabitBilgiMinSepetUcret" value="<?=$Listeleme['sabitBilgiMinSepetUcret']?>" autocomplete="off" >
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label for="sabitBilgiKargoUcret"><?=$fonk->getPDil("Kargo Ücreti")?></label>
												<input type="text" id="sabitBilgiKargoUcret" class="form-control border-primary" name="sabitBilgiKargoUcret" value="<?=$Listeleme['sabitBilgiKargoUcret']?>" autocomplete="off" >
											</div>
										</div>
									</div>
									<!-- /Güncellenecek Kısımlar -->
