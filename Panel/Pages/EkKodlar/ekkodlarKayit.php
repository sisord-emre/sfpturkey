	...
	if($_POST['formdan']=="1"){
		...
		if($primaryId!=""){
			...
			$parametreler=array(
				...
				'ekKodHead' => $ekKodHead,
				'ekKodBody' => $ekKodBody,
				'ekKodKayitTarihi' => date("Y-m-d H:i:s")
			);
		}
							...
							<form id="formpost" class="form" action="" method="post">
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="ekKodAdi"><?=$fonk->getPDil("Adı")?></label>
												<input type="text" class="form-control border-primary" id="ekKodAdi" name="ekKodAdi" value="<?=$Listeleme['ekKodAdi']?>" autocomplete="off" required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="ekKodDurum"><?=$fonk->getPDil("Durumu")?></label>
												<fieldset>
													<div class="float-left">
														<input type="checkbox" class="switch hidden" data-on-label="<?=$fonk->getPDil("Aktif")?>" data-off-label="<?=$fonk->getPDil("Pasif")?>" id="ekKodDurum" name="ekKodDurum" value="1" <?php if($Listeleme['ekKodDurum']==1){echo 'checked';}?> >
													</div>
												</fieldset>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="ekKodHead"><?=$fonk->getPDil("Head Bloğu")?></label>
												<textarea class="form-control" id="ekKodHead" name="ekKodHead" rows="15" placeholder="..."><?=$Listeleme['ekKodHead']?></textarea>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="ekKodBody"><?=$fonk->getPDil("Body Bloğu")?></label>
												<textarea class="form-control" id="ekKodBody" name="ekKodBody" rows="15" placeholder="..."><?=$Listeleme['ekKodBody']?></textarea>
											</div>
										</div>
									</div>
									<!-- /Güncellenecek Kısımlar -->
