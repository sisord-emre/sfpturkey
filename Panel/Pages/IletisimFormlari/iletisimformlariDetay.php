					...
					<table class="table table-bordered table-striped">
						<tbody>
							...
							<tr>
								...
								<td><?php if($detay['iletisimFormDurum']==1){?><div class="badge badge-success"><?=$fonk->getPDil("Okundu")?></div><?php } else{ ?><div class="badge badge-danger"><?=$fonk->getPDil("Beklemede")?></div><?php } ?></td>
							</tr>
							<tr>
