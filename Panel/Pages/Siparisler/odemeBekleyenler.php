...
if(!$listelemeYetki)
{
	...
	$baslik="Havale / Eft Ödemesi Bekleyen";//başlıkta gözükecek yazı menu adi
	...
	$sartlar=array_merge($sartlar,[
		"siparisOdemeTipiId" => 2, //havale eft
		"ORDER" => [
									...
									<table class="table table-striped table-bordered dataex-html5-export" id="listTable">
										...
										<tbody>
											...
											foreach($listeleme as $list){
												...
												if($siparisDurum["siparisSiparisDurumSiparisDurumId"]!=1){//ödeme bekleniyor ise yaz
													continue;
												}
