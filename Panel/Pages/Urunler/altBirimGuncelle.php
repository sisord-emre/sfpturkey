                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="urunVaryantDilBilgiDescription-<?= $dil["dilId"] ?>" name="urunVaryantDilBilgiDescription-<?= $dil["dilId"] ?>" rows="3" placeholder="..."><?= $item['urunVaryantDilBilgiDescription'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="editorCk3" id="urunVaryantDilBilgiAciklama-<?= $dil["dilId"] ?>" name="urunVaryantDilBilgiAciklama-<?= $dil["dilId"] ?>"><?= $item['urunVaryantDilBilgiAciklama'] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
