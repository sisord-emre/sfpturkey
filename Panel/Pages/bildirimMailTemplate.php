                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                  <tr>
                    <td class="headerContent">
                      ...
                      <img src="'.$sabitB["sabitBilgiSiteUrl"].'assets/img/logo.jpg" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                        ...
                        <tr>
                          <td valign="top">
                            <div mc:edit="std_footer">
                              <em>Copyright &copy; '.date('Y').' '.$sabitB["sabitBilgiSiteAdi"].', All rights reserved.</em>
