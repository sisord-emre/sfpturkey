										...
										<tbody>
											...
											foreach($listeleme as $list){
												...
												<tr id="trSatir-<?=$list[$tabloPrimarySutun];?>">
													...
													<td>
														<a href="<?=$list['pazarYeriGorselBaseUrl']?><?=$list['pazarYeriGorsel']?>" target="_blank">
															<img src="<?=$list['pazarYeriGorselBaseUrl']?><?=$list['pazarYeriGorsel']?>" width="70">
														</a>
													</td>
													<td><?=$list['pazarYeriAdi'];?></td>
													<td>
														<a href="<?=$list['pazarYeriLink'];?>" target="_blank">
															<?=$list['pazarYeriLink'];?>
														</a>
													</td>
													<td><?=$list['pazarYeriSirasi'];?></td>
													<td><?php if($list['pazarYeriDurum']==1){?><div class="badge badge-success"><?=$fonk->getPDil("Aktif")?></div><?php } else{ ?><div class="badge badge-danger"><?=$fonk->getPDil("Pasif")?></div><?php } ?></td>
													<td data-sort="<?=$fonk->sqlToDateTimeTiresiz($list['pazarYeriKayitTarihi']);?>"><?=$fonk->sqlToDateTime($list['pazarYeriKayitTarihi']);?></td>
													<!-- /Güncellenecek Kısımlar -->
