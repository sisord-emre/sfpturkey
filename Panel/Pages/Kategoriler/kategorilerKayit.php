	...
	if($_POST['formdan']=="1")
	{
		...
		foreach($dilList as $dil)
		{
			...
			$itemPar=array(
				...
				'kategoriDilBilgiAciklama' => $_POST["kategoriDilBilgiAciklama-".$dil["dilId"]],
														...
														<div class="card-content">
															<div class="card-body">
																<div class="row">
																	...
																	<div class="col-md-12">
																		<div class="form-group">
																			<label for="kategoriDilBilgiAciklama-<?=$dil["dilId"]?>"><?=$fonk->getPDil("Açıklama")?><small style="color:red;margin-left:1rem">*</small></label>
																			<textarea type="text" class="form-control border-primary" rows="4" cols="50" id="kategoriDilBilgiBaslik-<?=$dil["dilId"]?>" name="kategoriDilBilgiAciklama-<?=$dil["dilId"]?>"><?=$item['kategoriDilBilgiAciklama']?></textarea>
																		</div>
																	</div>
																</div>
															</div>
