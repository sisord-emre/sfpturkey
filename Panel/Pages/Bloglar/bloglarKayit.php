							...
							<form id="formpost" class="form" action="" method="post">
								<div class="form-body">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="blogDisLink"><?=$fonk->getPDil("Dış Link")?></label>
												<input type="text" class="form-control border-primary" id="blogDisLink" name="blogDisLink" value="<?=$Listeleme['blogDisLink']?>" autocomplete="off" required placeholder="https://...">
											</div>
										</div>
									</div>
